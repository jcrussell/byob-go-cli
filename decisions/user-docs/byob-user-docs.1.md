...
`--help` (and that byob-output.3 regenerates as Markdown/man pages on
...
4. **Where to look next.** Links to `--help`, generated reference
   docs, the troubleshooting page (byob-user-docs.5), and the repo.
