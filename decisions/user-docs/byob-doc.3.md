...
*and* the generated reference docs (byob-8u7.3) — investing in them
...
`ErrHint` messages (byob-kny.2) point at narrative troubleshooting
docs (byob-doc.5) for non-obvious failure modes — the union of
