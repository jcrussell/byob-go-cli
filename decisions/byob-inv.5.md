...
Idea: the `Options` struct (byob-n37.1) is the boundary between
...
`MarkFlagsOneRequired`, etc.) from byob-n37.6 already run before
...
`pflag.Value` types from byob-n37.7.
